...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <?= $this->Form->create(null, ['class' => 'form-horizontal']) ?>
            ...
            <div class="form-group">
                <label class="control-label col-sm-4" for="password"><?= __('Password') ?> <span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="top" title="<?= __('Database connection password') ?>"></span></label>
                <div class="col-sm-8">
